...
///
final class MyUser: Model, Content {
...
extension MyUser: ModelSessionAuthenticatable {}

// Authenticate users with username and password when they log in
extension MyUser: ModelCredentialsAuthenticatable {}

extension MyUser: ModelAuthenticatable {

   static let usernameKey = \MyUser.$username
   static let passwordHashKey = \MyUser.$password
